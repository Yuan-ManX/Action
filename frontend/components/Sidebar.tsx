...
const navItems = [
  ...
  { id: 'editor', label: 'AI Studio', href: '/dashboard/editor', icon: '🎬' },
  { id: 'chat', label: 'AI Canva', href: '/dashboard/chat', icon: '🎨' },
  { id: 'audio', label: 'AI Audio', href: '/dashboard/audio', icon: '🎵' },
    ...
    <div className={cn(
      ...
      <div className="flex items-center justify-between p-5 border-b border-oat-border">
        {!isCollapsed && (
          ...
          >
            <div className="w-10 h-10 bg-gradient-to-br from-lemon-500 via-slushie-500 to-ube-500 rounded-feature flex items-center justify-center text-xl shadow-clay relative overflow-hidden">
              🎬
              <motion.div
        ...
        {isCollapsed && (
          <div className="w-10 h-10 bg-gradient-to-br from-lemon-500 via-slushie-500 to-ube-500 rounded-feature flex items-center justify-center text-xl mx-auto shadow-clay relative overflow-hidden">
            🎬
            <motion.div
              initial={{ x: '-100%', opacity: 0.5 }}
              animate={{ x: ['200%', '-200%'] }}
      ...
      <div className="p-4 border-t border-oat-border">
        <motion.div
          ...
          onClick={() => !isCollapsed && setIsUserExpanded(!isUserExpanded)}
        >
          <div className="flex items-center gap-3 mb-3">
            ...
            {!isCollapsed && (
              ...
              >
                <motion.span
                  animate={{ rotate: isUserExpanded ? 180 : 0 }}
          ...
          {/* User Menu (Expandable with Animation) */}
          <AnimatePresence>
            {isUserExpanded && !isCollapsed && (
              <motion.div
